...
public class AsignarLotesEtapasEmpleadosScreen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        identificadorLoteComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

        descripcionEtapaComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

        numeroLegajoEmpleadoComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
